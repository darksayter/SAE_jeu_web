<?php
    ...
    if (isset($_SESSION['id_utilisateur'])) {
        ...
        try {
            ...
            // Vérifier si le chapitre 1 est complété pour débloquer le niveau 1 du chapitre 2
            $stmt = $con->prepare("SELECT id_chapitre FROM chapitrecomplete WHERE id_utilisateur = :id_utilisateur AND id_chapitre = 1");
            $stmt->bindParam(':id_utilisateur', $id_utilisateur);
            
            // Exécuter la requête
            $stmt->execute();

            // Vérifier si le chapitre 1 est complété
            $chapitre1_complete = $stmt->fetch(PDO::FETCH_ASSOC) ? true : false;
...
<head>
    <meta charset="UTF-8">
    <title>Selection des niveaux</title>
...
<body class="body">
    <div class="content">
        <!-- TITRE -->
        <h1 class="main-title">Chapitre 2</h1>
        <!-- Description -->
        <p class="description">
        ...
        <div class="button-container">
            <div class="row">
                <a href="Niveau1/Niveau1.php" class="custom-button <?php echo $chapitre1_complete ? '' : 'disabled'; ?>">Niveau 1</a>
            </div>
            <div class="row">
            ...
            <div class="row">
                <a href="Niveau4/Niveaux4.php" class="custom-button <?php echo $niveau_complete[3] ? '' : 'disabled'; ?>">Niveau 4</a>
            </div>
            <div class="row">

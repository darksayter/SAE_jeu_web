<?php
    ...
    if (isset($_SESSION['id_utilisateur'])) {
        ...
        try {
            ...
            // Vérifier si le chapitre 2 est complété pour débloquer le niveau 1 du chapitre 3
            $stmt = $con->prepare("SELECT id_chapitre FROM chapitrecomplete WHERE id_utilisateur = :id_utilisateur AND id_chapitre = 2");
            $stmt->bindParam(':id_utilisateur', $id_utilisateur);
            
            // Exécuter la requête
            $stmt->execute();

            // Vérifier si le chapitre 2 est complété
...
<body class="body">
    <div class="content">
        <!-- TITRE -->
        <h1 class="main-title">Chapitre 3</h1>
        <!-- Description -->
        <p class="description">
        ...
        <div class="button-container">
            <div class="row">
                <a href="Niveau1/Niveau1.php" class="custom-button <?php echo $chapitre2_complete ? '' : 'disabled'; ?>">Niveau 1</a>
            </div>
            <div class="row">
